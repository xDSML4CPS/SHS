 ...
 * </p>
 * <ul>
 *   <li>{@link org.xcpsml.xcpsml.cpsml.impl.IntervalImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xcpsml.xcpsml.cpsml.impl.IntervalImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link org.xcpsml.xcpsml.cpsml.impl.IntervalImpl#getRight <em>Right</em>}</li>
 *   <li>{@link org.xcpsml.xcpsml.cpsml.impl.IntervalImpl#getSubinterval <em>Subinterval</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntervalImpl extends EObjectImpl implements Interval {
	...
	protected EClass eStaticClass() {
		return CpsmlPackage.Literals.INTERVAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.INTERVAL__NAME, oldName, name));
	}
	...
	public void setLeft(float newLeft) {
		...
		left = newLeft;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.INTERVAL__LEFT, oldLeft, left));
	}
	...
	public void setRight(float newRight) {
		...
		right = newRight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.INTERVAL__RIGHT, oldRight, right));
	}
	...
	public void setSubinterval(float newSubinterval) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CpsmlPackage.INTERVAL__SUBINTERVAL, oldSubinterval, subinterval));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CpsmlPackage.INTERVAL__NAME:
				return getName();
			case CpsmlPackage.INTERVAL__LEFT:
				return getLeft();
			case CpsmlPackage.INTERVAL__RIGHT:
				return getRight();
			case CpsmlPackage.INTERVAL__SUBINTERVAL:
