...
public class TransitionAspectTransitionAspectContext {
  ...
  public static TransitionAspectTransitionAspectProperties getSelf(final Transition _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.dsml.cpsml.k3dsa.cpsml.aspects.TransitionAspectTransitionAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Transition, TransitionAspectTransitionAspectProperties> map = new java.util.WeakHashMap<cpsml.Transition, org.dsml.cpsml.k3dsa.cpsml.aspects.TransitionAspectTransitionAspectProperties>();
