...
import org.dsml.cpsml.k3dsa.cpsml.aspects.TransitionAspectTransitionAspectProperties;
...
public abstract class TransitionAspect {
  ...
  public static boolean holds(final Transition _self) {
    final org.dsml.cpsml.k3dsa.cpsml.aspects.TransitionAspectTransitionAspectProperties _self_ = org.dsml.cpsml.k3dsa.cpsml.aspects.TransitionAspectTransitionAspectContext.getSelf(_self);
    Object result = null;
    ...
    if (stepManager != null) {
    	stepManager.executeStep(_self,command,"Transition","holds");
    } else {
