...
import org.dsml.cpsml.k3dsa.cpsml.aspects.VariableAspectVariableAspectProperties;

@Aspect(className = Variable.class)
@SuppressWarnings("all")
public class VariableAspect {
  public static float Globalnv(final Variable _self) {
    final org.dsml.cpsml.k3dsa.cpsml.aspects.VariableAspectVariableAspectProperties _self_ = org.dsml.cpsml.k3dsa.cpsml.aspects.VariableAspectVariableAspectContext.getSelf(_self);
    Object result = null;
