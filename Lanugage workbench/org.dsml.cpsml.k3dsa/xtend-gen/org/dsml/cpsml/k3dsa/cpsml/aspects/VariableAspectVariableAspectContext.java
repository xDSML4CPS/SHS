...
public class VariableAspectVariableAspectContext {
  ...
  public static VariableAspectVariableAspectProperties getSelf(final Variable _self) {
    		if (!INSTANCE.map.containsKey(_self))
    			INSTANCE.map.put(_self, new org.dsml.cpsml.k3dsa.cpsml.aspects.VariableAspectVariableAspectProperties());
    		return INSTANCE.map.get(_self);
  }
  
  private Map<Variable, VariableAspectVariableAspectProperties> map = new java.util.WeakHashMap<cpsml.Variable, org.dsml.cpsml.k3dsa.cpsml.aspects.VariableAspectVariableAspectProperties>();
