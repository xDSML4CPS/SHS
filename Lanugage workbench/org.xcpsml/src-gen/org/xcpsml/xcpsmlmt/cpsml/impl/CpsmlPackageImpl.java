...
public class CpsmlPackageImpl extends EPackageImpl implements CpsmlPackage {
	 ...
	 * @see org.xcpsml.xcpsmlmt.cpsml.CpsmlPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSystem_CurrentState() {
	 ...
	 * @generated
	 */
	public EReference getSystem_FatherState() {
	 ...
	 * @generated
	 */
	public EReference getSystem_Ptok() {
	 ...
	 * @generated
	 */
	public EAttribute getSystem_Ran() {
	 ...
	 * @generated
	 */
	public EAttribute getSystem_Sub() {
	 ...
	 * @generated
	 */
	public EAttribute getSystem_Y0label() {
	 ...
	 * @generated
	 */
	public EAttribute getVariable_Globalnv() {
	...
	public void createPackageContents() {
		...
		createEReference(systemEClass, SYSTEM__CURRENT_STATE);
		createEReference(systemEClass, SYSTEM__FATHER_STATE);
		createEReference(systemEClass, SYSTEM__PTOK);
		createEAttribute(systemEClass, SYSTEM__RAN);
		createEAttribute(systemEClass, SYSTEM__SUB);
		createEAttribute(systemEClass, SYSTEM__Y0LABEL);

		variableEClass = createEClass(VARIABLE);
		createEAttribute(variableEClass, VARIABLE__VALUE);
		createEAttribute(variableEClass, VARIABLE__GLOBALNV);
	...
	public void initializePackageContents() {
		...
		initEClass(systemEClass, org.xcpsml.xcpsmlmt.cpsml.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSystem_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Ownedvariables(), this.getVariable(), null, "ownedvariables", null, 0, -1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Relatedvariable(), this.getVariable(), null, "relatedvariable", null, 1, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_OwnedStates(), this.getState(), null, "ownedStates", null, 0, -1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_OwnedTransitions(), this.getTransition(), null, "ownedTransitions", null, 0, -1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_InitialState(), this.getState(), null, "initialState", null, 1, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Ownedodes(), this.getODE(), null, "ownedodes", null, 0, -1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_CurrentState(), this.getState(), null, "currentState", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_FatherState(), this.getState(), null, "fatherState", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_Ptok(), this.getProbTransition(), null, "ptok", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Ran(), ecorePackage.getEFloatObject(), "ran", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Sub(), ecorePackage.getEInt(), "sub", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSystem_Y0label(), ecorePackage.getEInt(), "y0label", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVariable_Globalnv(), ecorePackage.getEFloat(), "Globalnv", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(transitionEClass, ecorePackage.getEBoolean(), "holds", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(odeEClass, org.xcpsml.xcpsmlmt.cpsml.ODE.class, "ODE", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getODE_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.xcpsml.xcpsmlmt.cpsml.ODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getODE_Function(), this.getFunction(), null, "function", null, 1, 1, org.xcpsml.xcpsmlmt.cpsml.ODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getODE_Condition(), this.getCondition(), null, "condition", null, 1, 1, org.xcpsml.xcpsmlmt.cpsml.ODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getODE_Interval(), this.getInterval(), null, "interval", null, 1, 1, org.xcpsml.xcpsmlmt.cpsml.ODE.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createAspectAnnotations() {
		...
		addAnnotation
		  (getSystem_CurrentState(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
		  (getSystem_FatherState(), 
		   source, 
		   new String[] {
		   });	
		addAnnotation
